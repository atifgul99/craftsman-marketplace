...
| Beige+brass premium palette (marketing) | `grep -rniE "#(f5f1ea\|f7f5f1\|fbf8f1\|efeae0\|ece6db\|b08947\|b6553a\|9a2436\|9c6e2a\|1a1714)" --include="*.tsx" --include="*.css"` — seeds for the family, not an exhaustive list | Rotate to a different palette family (see Visual AI Tells) unless the brand names these colors |
