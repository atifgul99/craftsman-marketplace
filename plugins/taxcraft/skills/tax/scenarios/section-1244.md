...
5. **Gross-receipts test** (§1244(c)(1)(C)): for the 5 most recent tax years before the loss year (or the corporation's whole life if shorter), **less than 50%** of aggregate gross receipts may come from royalties, rents, dividends, interest, annuities, and gains from sales/exchanges of stock or securities. **Carve-out for the classic failed startup** (§1244(c)(2)(C)): the test is waived entirely if the corporation's deductions (other than NOL and dividends-received deductions) exceeded its gross income over that period. Net effect: operating startups virtually always pass; holding/investment companies fail.
