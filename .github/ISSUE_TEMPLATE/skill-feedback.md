---
name: Skill feedback
about: Report a bug, gap, redundancy, or friction point in one of the craft skills
...
**Skill:** <!-- e.g. craft-backend -->

**Reference:** <!-- which reference file, or "SKILL.md" -->

**Type:** <!-- bug | gap | redundancy | friction | quality | suggestion -->
